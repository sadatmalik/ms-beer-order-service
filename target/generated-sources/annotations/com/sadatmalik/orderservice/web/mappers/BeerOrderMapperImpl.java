...
import com.sadatmalik.orderservice.domain.BeerOrder.BeerOrderBuilder;
import com.sadatmalik.orderservice.domain.BeerOrderLine;
import com.sadatmalik.orderservice.web.model.BeerOrderDto;
import com.sadatmalik.orderservice.web.model.BeerOrderDto.BeerOrderDtoBuilder;
import com.sadatmalik.orderservice.web.model.BeerOrderLineDto;
import com.sadatmalik.orderservice.web.model.OrderStatusEnum;
...
public class BeerOrderMapperImpl implements BeerOrderMapper {
    ...
    protected OrderStatusEnum orderStatusEnumToOrderStatusEnum(com.sadatmalik.orderservice.domain.OrderStatusEnum orderStatusEnum) {
    ...
    protected com.sadatmalik.orderservice.domain.OrderStatusEnum orderStatusEnumToOrderStatusEnum1(OrderStatusEnum orderStatusEnum) {
        if ( orderStatusEnum == null ) {
            return null;
        }

        com.sadatmalik.orderservice.domain.OrderStatusEnum orderStatusEnum1;

        switch ( orderStatusEnum ) {
            case NEW: orderStatusEnum1 = com.sadatmalik.orderservice.domain.OrderStatusEnum.NEW;
            break;
            case READY: orderStatusEnum1 = com.sadatmalik.orderservice.domain.OrderStatusEnum.READY;
            break;
            case PICKED_UP: orderStatusEnum1 = com.sadatmalik.orderservice.domain.OrderStatusEnum.PICKED_UP;
            break;
            default: throw new IllegalArgumentException( "Unexpected enum constant: " + orderStatusEnum );
        }
